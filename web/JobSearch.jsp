...
<body>
   <div id="background" style="position:absolute; left:0px; top:0px; width:100%; height:100%;">
      <img src="images/backgroundForSearch.jpg" width="100%" height="100%"/>
       <div style="position:absolute;width:100%;height:100%;z-indent:2;left:0;top:0;"id="searchpage">
      <div style="text-align:right;">
       <br /><br />
       <a href="TrendSearchers.jsp" style="color:#FFF;font-family:'宋体';font-size:20px;"><b>搜索指数</b></a>&nbsp
        <a href="login.jsp" style="color:#FFF;font-family:'宋体';font-size:20px;"><b>登录/注册</b></a>&nbsp;&nbsp;&nbsp;&nbsp;
       </div> 
       <br /><br /><br /><br />
       <div style="text-align:center;">
          <img src="images/logoForSearch.jpg" width="20%" height="10%"/>
       </div>
       <div style="text-align:center">
            <p style="text-align:center;font-size:20px;font-family:'华文新魏';color:#09F">让优秀的人才遇见更好的机会</p>
        <br /><br />
           ...
           <div style="display:inline;font-size:25px;font-family:'宋体';">
            ...
            <div style="display:inline;">
             ...
             <div style="display:inline">
             <input type="submit" style="font-family:'宋体';font-size:25px;background:#F00;color:#FFF;" value="找工作" >
             </div>
