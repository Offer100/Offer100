...
Page.prototype.__updateTableRows__ = function() {
	...
	if(this.pageIndex == 0){
		changeClass(document.getElementById("first"),"P_Font","P_DISABLE");
		changeClass(document.getElementById("pre"),"P_Font","P_DISABLE");
	}else{
		changeClass(document.getElementById("first"),"P_DISABLE","P_Font");
		changeClass(document.getElementById("pre"),"P_DISABLE","P_Font");
	}
	if(this.pageIndex + 1 ==this.pageCount){
		changeClass(document.getElementById("next"),"P_Font","P_DISABLE");
		changeClass(document.getElementById("last"),"P_Font","P_DISABLE");
	}else{
		changeClass(document.getElementById("next"),"P_DISABLE","P_Font");
		changeClass(document.getElementById("last"),"P_DISABLE","P_Font");
	}
	// alert(this.dataRows.length);
